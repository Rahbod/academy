    ...
    Route::group(['namespace'=>'Controllers\ContentManagement','prefix'=>'{lang}'],function(){
        ...
        Route::group(['prefix'=>'content_management','middleware'=>['auth:content_management','set_department:content_management' ,'user_info','lang','remove_additional_params']],function(){
                                                            ...
                                                            Route::get('/categories/get_actions', ['uses' =>'CategoryController@getActions','as' =>'content_management.Category.get_actions']);
                                                                                Route::get('/categories', ['uses' =>'CategoryController@index','as' =>'content_management.Category.index'])->middleware('acl:117');
                                                                                Route::get('/categories/list-view', ['uses' =>'CategoryController@listView','as' =>'content_management.Category.list_view'])->middleware('acl:118');
                                                                                Route::get('/categories/create', ['uses' =>'CategoryController@create','as' =>'content_management.Category.create'])->middleware('acl:119');
                                                                                Route::post('/categories', ['uses' =>'CategoryController@create','as' =>'content_management.Category.store'])->middleware('acl:119');
                                                                                Route::get('/categories/{id}', ['uses' =>'CategoryController@show','as' =>'content_management.Category.show'])->middleware('acl:120');
                                                                                Route::get('/categories/{id}/edit', ['uses' =>'CategoryController@edit','as' =>'content_management.Category.edit'])->middleware('acl:121');
                                                                                Route::put('/categories/{id}', ['uses' =>'CategoryController@edit','as' =>'content_management.Category.update'])->middleware('acl:121');
                                                                                Route::delete('/categories/{id}', ['uses' =>'CategoryController@destroy','as' =>'content_management.Category.destroy'])->middleware('acl:122');
                                                                                
                        
                                                            Route::get('/courses/get_actions', ['uses' =>'CourseController@getActions','as' =>'content_management.Course.get_actions']);
                                                                                Route::get('/courses', ['uses' =>'CourseController@index','as' =>'content_management.Course.index'])->middleware('acl:124');
                                                                                Route::get('/courses/list-view', ['uses' =>'CourseController@listView','as' =>'content_management.Course.list_view'])->middleware('acl:125');
                                                                                Route::get('/courses/create', ['uses' =>'CourseController@create','as' =>'content_management.Course.create'])->middleware('acl:126');
                                                                                Route::post('/courses', ['uses' =>'CourseController@create','as' =>'content_management.Course.store'])->middleware('acl:126');
                                                                                Route::get('/courses/{id}', ['uses' =>'CourseController@show','as' =>'content_management.Course.show'])->middleware('acl:127');
                                                                                Route::get('/courses/{id}/edit', ['uses' =>'CourseController@edit','as' =>'content_management.Course.edit'])->middleware('acl:128');
                                                                                Route::put('/courses/{id}', ['uses' =>'CourseController@edit','as' =>'content_management.Course.update'])->middleware('acl:128');
                                                                                Route::delete('/courses/{id}', ['uses' =>'CourseController@destroy','as' =>'content_management.Course.destroy'])->middleware('acl:129');
                                                                                Route::get('/courses/file_manager/connector', ['uses' =>'CourseController@showFileManagerConnector','as' =>'content_management.Course.showFileManagerConnector'])->middleware('acl:130');
                                                                                Route::post('/courses/file_manager/connector', ['uses' =>'CourseController@showFileManagerConnector','as' =>'content_management.Course.showFileManagerConnector'])->middleware('acl:130');
                                                                                Route::get('/courses/file_manager/{view}/{input_id?}', ['uses' =>'CourseController@showFileManager','as' =>'content_management.Course.showFileManager'])->middleware('acl:131');
                                                                                Route::get('/courses/settings/form', ['uses' =>'CourseController@updateSettings','as' =>'content_management.Course.updateSettings'])->middleware('acl:132');
                                                                                Route::put('/courses/settings/update', ['uses' =>'CourseController@updateSettings','as' =>'content_management.Course.updateSettings'])->middleware('acl:132');
                                                
                                                            Route::get('/class_rooms/get_actions', ['uses' =>'ClassRoomController@getActions','as' =>'content_management.ClassRoom.get_actions']);
                                                                                Route::get('/class_rooms', ['uses' =>'ClassRoomController@index','as' =>'content_management.ClassRoom.index'])->middleware('acl:134');
                                                                                Route::get('/class_rooms/list-view', ['uses' =>'ClassRoomController@listView','as' =>'content_management.ClassRoom.list_view'])->middleware('acl:135');
                                                                                Route::get('/class_rooms/create', ['uses' =>'ClassRoomController@create','as' =>'content_management.ClassRoom.create'])->middleware('acl:136');
                                                                                Route::post('/class_rooms', ['uses' =>'ClassRoomController@create','as' =>'content_management.ClassRoom.store'])->middleware('acl:136');
                                                                                Route::get('/class_rooms/{id}', ['uses' =>'ClassRoomController@show','as' =>'content_management.ClassRoom.show'])->middleware('acl:137');
                                                                                Route::get('/class_rooms/{id}/edit', ['uses' =>'ClassRoomController@edit','as' =>'content_management.ClassRoom.edit'])->middleware('acl:138');
                                                                                Route::put('/class_rooms/{id}', ['uses' =>'ClassRoomController@edit','as' =>'content_management.ClassRoom.update'])->middleware('acl:138');
                                                                                Route::delete('/class_rooms/{id}', ['uses' =>'ClassRoomController@destroy','as' =>'content_management.ClassRoom.destroy'])->middleware('acl:139');
                                                                                Route::get('/class_rooms/file_manager/connector', ['uses' =>'ClassRoomController@showFileManagerConnector','as' =>'content_management.ClassRoom.showFileManagerConnector'])->middleware('acl:140');
                                                                                Route::post('/class_rooms/file_manager/connector', ['uses' =>'ClassRoomController@showFileManagerConnector','as' =>'content_management.ClassRoom.showFileManagerConnector'])->middleware('acl:140');
                                                                                Route::get('/class_rooms/file_manager/{view}/{input_id?}', ['uses' =>'ClassRoomController@showFileManager','as' =>'content_management.ClassRoom.showFileManager'])->middleware('acl:141');
                                                                                Route::get('/class_rooms/settings/form', ['uses' =>'ClassRoomController@updateSettings','as' =>'content_management.ClassRoom.updateSettings'])->middleware('acl:142');
                                                                                Route::put('/class_rooms/settings/update', ['uses' =>'ClassRoomController@updateSettings','as' =>'content_management.ClassRoom.updateSettings'])->middleware('acl:142');
                                                                                
                        
                                                            Route::get('/contents/comments', ['uses' =>'ContentController@indexComment','as' =>'content_management.Content.indexComment'])->middleware('acl:143');
                                                                                Route::get('/contents/comments/list-view', ['uses' =>'ContentController@CommentsListView','as' =>'content_management.Content.CommentsListView'])->middleware('acl:144');
                                                                                Route::get('/contents/comments/{id}/edit', ['uses' =>'ContentController@editComment','as' =>'content_management.Content.editComment'])->middleware('acl:145');
                                                                                Route::put('/contents/comments/{id}', ['uses' =>'ContentController@editComment','as' =>'content_management.Content.editComment'])->middleware('acl:145');
                                                                                Route::get('/contents/comments/{id}', ['uses' =>'ContentController@showComment','as' =>'content_management.Content.showComment'])->middleware('acl:146');
                                                                                Route::delete('/contents/comments/{id}', ['uses' =>'ContentController@destroyComment','as' =>'content_management.Content.destroyComment'])->middleware('acl:147');
                                                                                Route::get('/contents/get_actions', ['uses' =>'ContentController@getActions','as' =>'content_management.Content.get_actions']);
                                                                                Route::get('/contents', ['uses' =>'ContentController@index','as' =>'content_management.Content.index'])->middleware('acl:149');
                                                                                Route::get('/contents/list-view', ['uses' =>'ContentController@listView','as' =>'content_management.Content.list_view'])->middleware('acl:150');
                                                                                Route::get('/contents/create', ['uses' =>'ContentController@create','as' =>'content_management.Content.create'])->middleware('acl:151');
                                                                                Route::post('/contents', ['uses' =>'ContentController@create','as' =>'content_management.Content.store'])->middleware('acl:151');
                                                                                Route::get('/contents/{id}', ['uses' =>'ContentController@show','as' =>'content_management.Content.show'])->middleware('acl:152');
                                                                                Route::get('/contents/{id}/edit', ['uses' =>'ContentController@edit','as' =>'content_management.Content.edit'])->middleware('acl:153');
                                                                                Route::put('/contents/{id}', ['uses' =>'ContentController@edit','as' =>'content_management.Content.update'])->middleware('acl:153');
                                                                                Route::delete('/contents/{id}', ['uses' =>'ContentController@destroy','as' =>'content_management.Content.destroy'])->middleware('acl:154');
                                                                                Route::get('/contents/file_manager/connector', ['uses' =>'ContentController@showFileManagerConnector','as' =>'content_management.Content.showFileManagerConnector'])->middleware('acl:155');
                                                                                Route::post('/contents/file_manager/connector', ['uses' =>'ContentController@showFileManagerConnector','as' =>'content_management.Content.showFileManagerConnector'])->middleware('acl:155');
                                                                                Route::get('/contents/file_manager/{view}/{input_id?}', ['uses' =>'ContentController@showFileManager','as' =>'content_management.Content.showFileManager'])->middleware('acl:156');
                                                                                Route::get('/contents/settings/form', ['uses' =>'ContentController@updateSettings','as' =>'content_management.Content.updateSettings'])->middleware('acl:157');
                                                                                Route::put('/contents/settings/update', ['uses' =>'ContentController@updateSettings','as' =>'content_management.Content.updateSettings'])->middleware('acl:157');
                                                                                
                        
                                                            Route::get('/pages/comments', ['uses' =>'PageController@indexComment','as' =>'content_management.Page.indexComment'])->middleware('acl:158');
                                                                                Route::get('/pages/comments/list-view', ['uses' =>'PageController@CommentsListView','as' =>'content_management.Page.CommentsListView'])->middleware('acl:159');
                                                                                Route::get('/pages/comments/{id}/edit', ['uses' =>'PageController@editComment','as' =>'content_management.Page.editComment'])->middleware('acl:160');
                                                                                Route::put('/pages/comments/{id}', ['uses' =>'PageController@editComment','as' =>'content_management.Page.editComment'])->middleware('acl:160');
                                                                                Route::get('/pages/comments/{id}', ['uses' =>'PageController@showComment','as' =>'content_management.Page.showComment'])->middleware('acl:161');
                                                                                Route::delete('/pages/comments/{id}', ['uses' =>'PageController@destroyComment','as' =>'content_management.Page.destroyComment'])->middleware('acl:162');
                                                                                Route::get('/pages/get_actions', ['uses' =>'PageController@getActions','as' =>'content_management.Page.get_actions']);
                                                                                Route::get('/pages', ['uses' =>'PageController@index','as' =>'content_management.Page.index'])->middleware('acl:164');
                                                                                Route::get('/pages/list-view', ['uses' =>'PageController@listView','as' =>'content_management.Page.list_view'])->middleware('acl:165');
                                                                                Route::get('/pages/create', ['uses' =>'PageController@create','as' =>'content_management.Page.create'])->middleware('acl:166');
                                                                                Route::post('/pages', ['uses' =>'PageController@create','as' =>'content_management.Page.store'])->middleware('acl:166');
                                                                                Route::get('/pages/{id}', ['uses' =>'PageController@show','as' =>'content_management.Page.show'])->middleware('acl:167');
                                                                                Route::get('/pages/{id}/edit', ['uses' =>'PageController@edit','as' =>'content_management.Page.edit'])->middleware('acl:168');
                                                                                Route::put('/pages/{id}', ['uses' =>'PageController@edit','as' =>'content_management.Page.update'])->middleware('acl:168');
                                                                                Route::delete('/pages/{id}', ['uses' =>'PageController@destroy','as' =>'content_management.Page.destroy'])->middleware('acl:169');
                                                                                Route::get('/pages/file_manager/connector', ['uses' =>'PageController@showFileManagerConnector','as' =>'content_management.Page.showFileManagerConnector'])->middleware('acl:170');
                                                                                Route::post('/pages/file_manager/connector', ['uses' =>'PageController@showFileManagerConnector','as' =>'content_management.Page.showFileManagerConnector'])->middleware('acl:170');
                                                                                Route::get('/pages/file_manager/{view}/{input_id?}', ['uses' =>'PageController@showFileManager','as' =>'content_management.Page.showFileManager'])->middleware('acl:171');
                                                                                Route::get('/pages/settings/form', ['uses' =>'PageController@updateSettings','as' =>'content_management.Page.updateSettings'])->middleware('acl:172');
                                                                                Route::put('/pages/settings/update', ['uses' =>'PageController@updateSettings','as' =>'content_management.Page.updateSettings'])->middleware('acl:172');
                                                                                
                        
                                                            Route::get('/slider_groups/get_actions', ['uses' =>'SliderGroupController@getActions','as' =>'content_management.SliderGroup.get_actions']);
                                                                                Route::get('/slider_groups', ['uses' =>'SliderGroupController@index','as' =>'content_management.SliderGroup.index'])->middleware('acl:174');
                                                                                Route::get('/slider_groups/list-view', ['uses' =>'SliderGroupController@listView','as' =>'content_management.SliderGroup.list_view'])->middleware('acl:175');
                                                                                Route::get('/slider_groups/create', ['uses' =>'SliderGroupController@create','as' =>'content_management.SliderGroup.create'])->middleware('acl:176');
                                                                                Route::post('/slider_groups', ['uses' =>'SliderGroupController@create','as' =>'content_management.SliderGroup.store'])->middleware('acl:176');
                                                                                Route::get('/slider_groups/{id}', ['uses' =>'SliderGroupController@show','as' =>'content_management.SliderGroup.show'])->middleware('acl:177');
                                                                                Route::get('/slider_groups/{id}/edit', ['uses' =>'SliderGroupController@edit','as' =>'content_management.SliderGroup.edit'])->middleware('acl:178');
                                                                                Route::put('/slider_groups/{id}', ['uses' =>'SliderGroupController@edit','as' =>'content_management.SliderGroup.update'])->middleware('acl:178');
                                                                                Route::delete('/slider_groups/{id}', ['uses' =>'SliderGroupController@destroy','as' =>'content_management.SliderGroup.destroy'])->middleware('acl:179');
                                                
                                                            Route::get('/sliders/get_actions', ['uses' =>'SliderController@getActions','as' =>'content_management.Slider.get_actions']);
                                                                                Route::get('/sliders', ['uses' =>'SliderController@index','as' =>'content_management.Slider.index'])->middleware('acl:181');
                                                                                Route::get('/sliders/list-view', ['uses' =>'SliderController@listView','as' =>'content_management.Slider.list_view'])->middleware('acl:182');
                                                                                Route::get('/sliders/create', ['uses' =>'SliderController@create','as' =>'content_management.Slider.create'])->middleware('acl:183');
                                                                                Route::post('/sliders', ['uses' =>'SliderController@create','as' =>'content_management.Slider.store'])->middleware('acl:183');
                                                                                Route::get('/sliders/{id}', ['uses' =>'SliderController@show','as' =>'content_management.Slider.show'])->middleware('acl:184');
                                                                                Route::get('/sliders/{id}/edit', ['uses' =>'SliderController@edit','as' =>'content_management.Slider.edit'])->middleware('acl:185');
                                                                                Route::put('/sliders/{id}', ['uses' =>'SliderController@edit','as' =>'content_management.Slider.update'])->middleware('acl:185');
                                                                                Route::delete('/sliders/{id}', ['uses' =>'SliderController@destroy','as' =>'content_management.Slider.destroy'])->middleware('acl:186');
                                                                                Route::get('/sliders/file_manager/connector', ['uses' =>'SliderController@showFileManagerConnector','as' =>'content_management.Slider.showFileManagerConnector'])->middleware('acl:187');
                                                                                Route::post('/sliders/file_manager/connector', ['uses' =>'SliderController@showFileManagerConnector','as' =>'content_management.Slider.showFileManagerConnector'])->middleware('acl:187');
                                                                                Route::get('/sliders/file_manager/{view}/{input_id?}', ['uses' =>'SliderController@showFileManager','as' =>'content_management.Slider.showFileManager'])->middleware('acl:188');
                                                                                Route::get('/sliders/settings/form', ['uses' =>'SliderController@updateSettings','as' =>'content_management.Slider.updateSettings'])->middleware('acl:189');
                                                                                Route::put('/sliders/settings/update', ['uses' =>'SliderController@updateSettings','as' =>'content_management.Slider.updateSettings'])->middleware('acl:189');
                                                                                
                        
                                                            Route::get('/tags/get_actions', ['uses' =>'TagController@getActions','as' =>'content_management.Tag.get_actions']);
                                                                                Route::get('/tags', ['uses' =>'TagController@index','as' =>'content_management.Tag.index'])->middleware('acl:191');
                                                                                Route::get('/tags/list-view', ['uses' =>'TagController@listView','as' =>'content_management.Tag.list_view'])->middleware('acl:192');
                                                                                Route::get('/tags/create', ['uses' =>'TagController@create','as' =>'content_management.Tag.create'])->middleware('acl:193');
                                                                                Route::post('/tags', ['uses' =>'TagController@create','as' =>'content_management.Tag.store'])->middleware('acl:193');
                                                                                Route::get('/tags/{id}', ['uses' =>'TagController@show','as' =>'content_management.Tag.show'])->middleware('acl:194');
                                                                                Route::get('/tags/{id}/edit', ['uses' =>'TagController@edit','as' =>'content_management.Tag.edit'])->middleware('acl:195');
                                                                                Route::put('/tags/{id}', ['uses' =>'TagController@edit','as' =>'content_management.Tag.update'])->middleware('acl:195');
                                                                                Route::delete('/tags/{id}', ['uses' =>'TagController@destroy','as' =>'content_management.Tag.destroy'])->middleware('acl:196');
                                                                                
                        
                                                            Route::get('/static_menus/get_actions', ['uses' =>'StaticMenuController@getActions','as' =>'content_management.StaticMenu.get_actions']);
                                                                                Route::get('/static_menus', ['uses' =>'StaticMenuController@index','as' =>'content_management.StaticMenu.index'])->middleware('acl:198');
                                                                                Route::get('/static_menus/list-view', ['uses' =>'StaticMenuController@listView','as' =>'content_management.StaticMenu.list_view'])->middleware('acl:199');
                                                                                Route::get('/static_menus/create', ['uses' =>'StaticMenuController@create','as' =>'content_management.StaticMenu.create'])->middleware('acl:200');
                                                                                Route::post('/static_menus', ['uses' =>'StaticMenuController@create','as' =>'content_management.StaticMenu.store'])->middleware('acl:200');
                                                                                Route::get('/static_menus/{id}', ['uses' =>'StaticMenuController@show','as' =>'content_management.StaticMenu.show'])->middleware('acl:201');
                                                                                Route::get('/static_menus/{id}/edit', ['uses' =>'StaticMenuController@edit','as' =>'content_management.StaticMenu.edit'])->middleware('acl:202');
                                                                                Route::put('/static_menus/{id}', ['uses' =>'StaticMenuController@edit','as' =>'content_management.StaticMenu.update'])->middleware('acl:202');
                                                                                Route::delete('/static_menus/{id}', ['uses' =>'StaticMenuController@destroy','as' =>'content_management.StaticMenu.destroy'])->middleware('acl:203');
                                                                            });
