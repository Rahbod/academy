<footer class="site-footer" style="height: 526.656px;">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-5 footer-col-4">
                    ...
                    <ul class="list-inline mb-5 mb-lg-0">
                        ...
                        <li><a href="javascript:void(0);" class="site-button twitter sharp"><i
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 footer-col-4">
                    <div class="widget widget_getintuch">
                        ...
                        <div class="dlab-separator bg-white"></div>
                        <div class="search-bx">
                            <form method="post" class="contactUsForm" action="">
                        ...
                        <ul class="clearfix mfp-gallery">
                            ...
                            <li class="img-effect2">
                                <a class="mfp-link html5lightbox" data-group="mygroup"
                                   ...
                                   title="Title Come Here"><img
                                            src="{{asset('/assets/site/media/images/promotion/img4.jpg')}}" alt=""></a></li>
                            <li class="img-effect2">
                                <a class="mfp-link html5lightbox" data-group="mygroup"
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 text-left"><span>Copyright © 2019 Rahbod</span></div>
                <div class="col-lg-6 col-md-6 text-right "><span> Design With <i
                                class="fa fa-heart text-primary heart"></i> By Rahbod </span></div>
            </div>
        </div>
    </div>
</footer>